 ...
 */
 define(function (require) {
    ...
    Painter.prototype = {
        ...
        /**
         * èŽ·å– zlevel æ‰€åœ¨å±‚ï¼Œå¦‚æžœä¸å­˜åœ¨åˆ™ä¼šåˆ›å»ºä¸€ä¸ªæ–°çš„å±‚
         * @param {number} zlevel
         ...
         *                 åœ¨å¼€å¯åŠ¨æ€æ¨¡ç³Šçš„æ—¶å€™ä½¿ç”¨ï¼Œä¸Žä¸Šä¸€å¸§æ··åˆçš„alphaå€¼ï¼Œå€¼è¶Šå¤§å°¾è¿¹è¶Šæ˜Žæ˜¾
         */
        ...
        _pathToImage: function (id, path, width, height, dpr) {
            ...
            var ImageShape = require('./graphic/Image.js');
