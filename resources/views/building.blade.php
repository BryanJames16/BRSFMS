...
@section('modal-form-body')
	...
	<div>
		<div class="form-group row">
			...
			<div class="col-md-9">
				{!! Form::text('buildingCode', null, ['id' => 'buildingCode', 
													'class' => 'form-control', 
													'ng-model' => 'service.typename', 
													'placeholder' => 'eg.BLD001', 
						...
						$("#table-container").append('<tr>' + 
									...
									'<td>' + 
										'<form method="POST" id="' + data[index].buildingID + '" action="/building/delete" accept-charset="UTF-8"])!!}' + 
											...
											'<input type="hidden" name="buildingCode" value="' + data[index].buildingCode + '" />' + 
                                            '<input type="hidden" name="buildingName" value="' + data[index].buildingName + '" />' + 
											'<input type="hidden" name="buildingType" value="' + data[index].buildingType + '" />' + 
		...
		<tr>
			...
			<td>
				{!! Form::open(['url'=>'building/delete', 'method' => 'POST', 'id' => $building -> buildingID ]) !!}
                    ...
                    <input type='hidden' name='buildingCode' value='{{ $building -> buildingCode }}' />
					<input type='hidden' name='buildingName' value='{{ $building -> buildingName }}' />
					<input type='hidden' name='buildingType' value='{{ $building -> buildingType }}' />
...
@section('edit-modal-body')
    ...
    <div class="form-group row">
		<label class="col-md-3 label-control" for="eventRegInput1">*Code</label>
		<div class="col-md-9">
			{!!Form::text('buildingCode',null,['id'=>'buildingCode','class'=>'form-control', 'maxlength'=>'30'])!!}
		</div>	
	...
	<div class="form-group row">
		<label class="col-md-3 label-control" for="eventRegInput1">Type</label>
		<div class="col-md-9">
			{!!Form::text('buildingType',null,['id'=>'buildingType','class'=>'form-control', 'maxlength'=>'500','data-toggle'=>'tooltip','data-trigger'=>'focus','data-placement'=>'top','data-title'=>'Maximum of 500 characters'])!!}
		</div>	
