    ...
    <body>
        ...
        <div style="width:900px;height:595px;margin:auto;">
           ...
           @endif
            ...
            <table id="tbl" style="font-size:15px;margin:auto;padding:8px;border-collapse:collapse;width:100%;table-layout:fixed">
                ...
                <tbody id="body" style="text-align:center;width:100%">
                    ...
                    <tr style="border:1px solid black">
                        ...
                        <td></td>
                        <td></td>
                        <td colspan="2" style="text-align:right">TOTAL PWDs: </td>
                    ...
                    <tr style="border:1px solid black">
                        ...
                        <td></td>
                        <td></td>
                        <td colspan="2" style="text-align:right">TOTAL MALE PWD: </td>
                    ...
                    <tr style="border:1px solid black">
                        ...
                        <td></td>
                        <td></td>
                        <td colspan="2" style="text-align:right">TOTAL FEMALE PWD: </td>
                    ...
                    <tr style="border:1px solid black">
                        ...
                        <td></td>
                        <td></td>
                        <td colspan="2" style="text-align:right">AVERAGE AGE OF PWDs: </td>
