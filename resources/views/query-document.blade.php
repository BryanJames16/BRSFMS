			...
			<div class="col-xs-4">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title">Query for Document</h4>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="form-group col-md-6 mb-2">
                                        <label for="userinput2">Document</label>
                                        {!! Form::text('document', null, ['id' => 'document','class' => 'form-control border-primary', 'placeholder'=> '']) !!}
                                    </div>
                                    <div class="form-group col-md-6 mb-2">
                                        <label for="userinput3">Resident</label>
                                        {!! Form::text('middleName', null, ['id' => 'middleName','class' => 'form-control border-primary', 'placeholder'=> '']) !!}
                                    </div>
                                    <div class="form-group col-md-6 mb-2">
                                        <label for="userinput3">Quantity</label>
                                        {!! Form::number('quantity', null, ['id' => 'quantity','class' => 'form-control border-primary', 'placeholder'=> '']) !!}
                                    </div>
                                    <div class="form-group col-md-6 mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        {!! Form::date('date', null, ['id' => 'date','class' => 'form-control border-primary']) !!}
                                    </div>
