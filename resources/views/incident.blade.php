...
<html lang="en" data-textdirection="LTR" class="loading">
  <head>
    ...
    <title>Barangay 629 Resident, Services and Facility Management System</title>
      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href=".//dashboard" class="navbar-brand nav-link"><img alt="branding logo" src="./robust-assets/images/logo/brgy_logoo.png" data-expand="robust-assets/images/logo/brgy_logoo.png" data-collapse="robust-assets/images/logo/brgy_logoo.png" class="brand-logo" style="width:200px;"/></a></li>
    ...
    <div class="main-menu menu-dark menu-fixed menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" navigation-header"><span data-i18n="nav.category.layouts">Maintenance</span><i data-toggle="tooltip" data-placement="right" data-original-title="Maintenance" class="icon-ellipsis icon-ellipsis"></i>
          </li>
		  <li class=" nav-item"><a href="./individual"><i class="icon-user"></i><span data-i18n="nav.dash.main" class="menu-title">Individual</span></a>
          </li>
		  <li class=" nav-item"><a href="./facility"><i class="icon-office"></i><span data-i18n="nav.dash.main" class="menu-title">Facility</span></a>
          </li>
		  <li class=" nav-item"><a href="./address"><i class="icon-/home32"></i><span data-i18n="nav.dash.main" class="menu-title">Address</span></a>
          </li>
		  <li class=" nav-item"><a href="./services"><i class="icon-cogs"></i><span data-i18n="nav.dash.main" class="menu-title">Services</span></a>
          </li>
		  <li class=" nav-item"><a href="./incident"><i class="icon-newspaper"></i><span data-i18n="nav.dash.main" class="menu-title">Incident Report</span></a>
          </li>

		  <li class=" navigation-header"><span data-i18n="nav.category.layouts">Transaction</span><i data-toggle="tooltip" data-placement="right" data-original-title="Transaction" class="icon-ellipsis icon-ellipsis"></i>
          </li>
		  <li class=" nav-item"><a href="./residentapp"><i class="icon-user"></i><span data-i18n="nav.dash.main" class="menu-title">Resident Application</span></a>
          </li>
		  <li class=" nav-item"><a href="./employeeapp"><i class="icon-office"></i><span data-i18n="nav.dash.main" class="menu-title">Employee Registration</span></a>
          </li>
		  <li class=" nav-item"><a href="#"><i class="icon-folder2"></i><span data-i18n="nav.navbars.main" class="menu-title">Case</span></a>
            <ul class="menu-content">
              <li><a href="./case-blotter.html" data-i18n="nav.navbars.nav_light" class="menu-item">Blotter Case</a>
              </li>
              <li><a href="./case-formal.html" data-i18n="nav.navbars.nav_dark" class="menu-item">Formal Case</a>
              </li>
            </ul>
          </li>
		  
		  <li class=" nav-item"><a href="#"><i class="icon-file-text2"></i><span data-i18n="nav.navbars.main" class="menu-title">Documents</span></a>
            <ul class="menu-content">
              <li><a href="./doc-goodmoral.html" data-i18n="nav.navbars.nav_light" class="menu-item">Certificate of Good Moral</a>
              </li>
              <li><a href="./doc-indigency.html" data-i18n="nav.navbars.nav_dark" class="menu-item">Certificate of Indigency</a>
              </li>
			  <li><a href="./doc-clearance.html" data-i18n="nav.navbars.nav_dark" class="menu-item">Barangay Clearance</a>
              </li>
			  <li><a href="./doc-senior.html" data-i18n="nav.navbars.nav_dark" class="menu-item">Senior Citizen</a>
              </li>
            </ul>
          </li>
		  <br/>
		  <li class=" nav-item"><a href="./query.html"><i class="icon-question"></i><span data-i18n="nav.dash.main" class="menu-title">Query</span></a>
          </li>
		  
		  <li class=" nav-item"><a href="./utilities.html"><i class="icon-wrench3"></i><span data-i18n="nav.dash.main" class="menu-title">Utilities</span></a>
          </li>
		  
		  <li class=" nav-item"><a href="./report.html"><i class="icon-stats-bars2"></i><span data-i18n="nav.dash.main" class="menu-title">Report</span></a>
          </li>
      ...
      <div class="content-wrapper">
		...
		<div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Incident Report
              </li>
            </ol>
          </div>
        </div>
