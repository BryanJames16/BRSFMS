...
Route::get('/facility-reservation/checkR', 'ReservationController@checkR');
...
Route::get('/facility-reservation/getResDetails', 'ReservationController@getResDetails');
Route::get('/facility-reservation/checkReservation', 'ReservationController@checkReservation');
...
Route::post('/users/maintenanceAllow', 'UsersController@maintenanceAllow');
Route::post('/users/maintenanceRestrict', 'UsersController@maintenanceRestrict');
Route::post('/users/reportAllow', 'UsersController@reportAllow');
Route::post('/users/reportRestrict', 'UsersController@reportRestrict');
Route::post('/users/utilitiesAllow', 'UsersController@utilitiesAllow');
Route::post('/users/utilitiesRestrict', 'UsersController@utilitiesRestrict');
Route::post('/users/queryAllow', 'UsersController@queryAllow');
Route::post('/users/queryRestrict', 'UsersController@queryRestrict');
