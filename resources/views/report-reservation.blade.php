...
@section('js-setting')
	...
	<script type="text/javascript">
		setSelectedTab(REPORT_RESERVATION);
	</script>
@endsection
...
<div class="card-body collapse in">
    <div class="card-block card-dashboard">
        ...
        <p >
            ...
            <iframe id="iframe" style="width:100%;height:100%" frameborder="1" src="/reports/reservation/previewAll"></iframe>
        </p>
    </div>
</div>
@endsection
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#printAll', function(e) {
            ...
            swal({
                    ...
                    function() {
                        ...
                        $.ajax({
                            url: '{{ url("/reports/reservation/printAll") }}', 
                            method: 'GET', 
                            async: false, 
            ...
            else
            {
                swal({
                    ...
                    function() {
                        ...
                        $.ajax({
                            url: '{{ url("/reports/reservation/printRange") }}', 
                            method: 'GET', 
                            data: {
                                'fromDate': fDate,
                                'toDate': tDate
        ...
        $(document).on('click', '#previewRange', function(e) {
            ...
            if($("#min-date-id").val()=='' || $("#quota-date-id").val()=='')
            {
                ...
                $('#iframe').attr('src','/reports/reservation/previewRange/'+ fDate +'/'+ tDate)
            }
        ...
        $(document).on('click', '#previewAll', function(e) {
            ...
            $('#iframe').attr('src','/reports/reservation/previewAll');
